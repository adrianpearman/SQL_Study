...
-- ANSWER:
SELECT name FROM cd.facilities WHERE name ilike '%tennis%'

-- OR

SELECT bookings.facid, name, starttime FROM cd.bookings
...
-- ANSWER:
SELECT distinct(surname) FROM cd.members WHERE memid > 0 ORDER BY surname ASC LIMIT 10
